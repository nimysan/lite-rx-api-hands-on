...
//========================================================================================
	...
	Flux<User> fluxWithDoOnPrintln() {
		return repository.findAll().doOnNext(t->System.out.println(t.getFirstname()+" " + t.getLastname())).doOnSubscribe(t-> {System.out.println("Starring");}).doOnComplete( ()->System.out.println("The End!"));
	}
